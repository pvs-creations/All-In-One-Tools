...
class ManageAimTrainerSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Aim Trainer Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = AimTrainerSettings::class;
