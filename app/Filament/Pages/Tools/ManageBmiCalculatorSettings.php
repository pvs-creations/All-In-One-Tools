...
class ManageBmiCalculatorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Bmi Calculator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = BmiCalculatorSettings::class;
