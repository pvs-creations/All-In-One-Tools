...
class ManageCaseConverterSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Case Converter Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = CaseConverterSettings::class;
