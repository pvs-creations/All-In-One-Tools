...
class ManageCountDownTimerSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Count Down Timer Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = CountDownTimerSettings::class;
