...
class ManageCreditCardValidatorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Credit Card Validator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = CreditCardValidatorSettings::class;
