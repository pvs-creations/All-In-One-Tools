...
class ManageDatePickerCalendarSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Date Picker Calendar Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = DatePickerCalendarSettings::class;
