...
class ManageDnsLookupSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Dns Lookup Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = DnsLookupSettings::class;
