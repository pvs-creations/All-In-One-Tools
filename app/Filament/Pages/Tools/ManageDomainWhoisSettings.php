...
class ManageDomainWhoisSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Domain Whois Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = DomainWhoisSettings::class;
