...
use App\Settings\Tools\FakeNameGeneratorSettings;
use App\Filament\Extensions\BitflanSettingsPage;
use App\Settings\LanguageSettings;
use Filament\Forms\Components;

class ManageFakeNameGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Fake Name Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = FakeNameGeneratorSettings::class;
