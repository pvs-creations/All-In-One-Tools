...
class ManageHtmlCodeEditorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Html Code Editor Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HtmlCodeEditorSettings::class;
