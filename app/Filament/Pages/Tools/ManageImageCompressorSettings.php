...
class ManageImageCompressorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Image Compressor Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = ImageCompressorSettings::class;
