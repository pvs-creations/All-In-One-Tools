...
class ManageImageRotateSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Image Rotate Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = ImageRotateSettings::class;
