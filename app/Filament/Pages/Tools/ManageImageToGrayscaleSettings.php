...
class ManageImageToGrayscaleSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Image To Grayscale Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = ImageToGrayscaleSettings::class;
