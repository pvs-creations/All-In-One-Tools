...
class ManageJPGToPNGSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Jpg To Png Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = JPGToPNGSettings::class;
