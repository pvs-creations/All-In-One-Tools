...
class ManageJPGToWEBPSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Jpg To Webp Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = JPGToWEBPSettings::class;
