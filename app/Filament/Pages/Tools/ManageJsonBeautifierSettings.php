...
class ManageJsonBeautifierSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Json Beautifier Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = JsonBeautifierSettings::class;
