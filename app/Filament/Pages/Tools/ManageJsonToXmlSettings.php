...
class ManageJsonToXmlSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Json To Xml Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = JsonToXmlSettings::class;
