...
class ManageLengthConverterSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Length Converter Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = LengthConverterSettings::class;
