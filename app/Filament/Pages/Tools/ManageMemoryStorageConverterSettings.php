...
class ManageMemoryStorageConverterSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Memory Storage Converter Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = MemoryStorageConverterSettings::class;
