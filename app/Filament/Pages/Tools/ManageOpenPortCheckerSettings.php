...
class ManageOpenPortCheckerSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Open Port Checker Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = OpenPortCheckerSettings::class;
