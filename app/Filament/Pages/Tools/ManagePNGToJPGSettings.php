...
class ManagePNGToJPGSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Png To Jpg Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = PNGToJPGSettings::class;
