...
class ManagePNGToWEBPSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Png To Webp Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = PNGToWEBPSettings::class;
