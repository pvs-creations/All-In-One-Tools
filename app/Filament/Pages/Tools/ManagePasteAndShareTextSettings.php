...
class ManagePasteAndShareTextSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Paste And Share Text Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = PasteAndShareTextSettings::class;
