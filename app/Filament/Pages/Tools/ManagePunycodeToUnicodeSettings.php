...
class ManagePunycodeToUnicodeSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Punycode To Unicode Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = PunycodeToUnicodeSettings::class;
