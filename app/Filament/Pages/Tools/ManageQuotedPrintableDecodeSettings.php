...
class ManageQuotedPrintableDecodeSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Quoted Printable Decode Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = QuotedPrintableDecodeSettings::class;
