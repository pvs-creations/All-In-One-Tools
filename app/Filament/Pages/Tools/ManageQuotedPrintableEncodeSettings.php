...
class ManageQuotedPrintableEncodeSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Quoted Printable Encode Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = QuotedPrintableEncodeSettings::class;
