...
class ManageROT13EncoderSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Rot13 Encoder Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = ROT13EncoderSettings::class;
