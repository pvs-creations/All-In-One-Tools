...
class ManageRandomNumberGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Random Number Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = RandomNumberGeneratorSettings::class;
