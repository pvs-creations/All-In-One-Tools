...
class ManageRandomTextLineSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Random Text Line Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = RandomTextLineSettings::class;
