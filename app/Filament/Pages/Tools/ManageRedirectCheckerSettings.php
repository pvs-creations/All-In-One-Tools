...
class ManageRedirectCheckerSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Redirect Checker Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = RedirectCheckerSettings::class;
