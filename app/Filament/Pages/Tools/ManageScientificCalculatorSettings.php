...
class ManageScientificCalculatorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Scientific Calculator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = ScientificCalculatorSettings::class;
