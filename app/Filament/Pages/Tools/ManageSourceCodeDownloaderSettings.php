...
class ManageSourceCodeDownloaderSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Source Code Downloader Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = SourceCodeDownloaderSettings::class;
