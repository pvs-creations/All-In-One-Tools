...
class ManageSpeedConverterSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Speed Converter Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = SpeedConverterSettings::class;
