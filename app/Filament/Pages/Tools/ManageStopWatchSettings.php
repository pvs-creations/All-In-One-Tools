...
class ManageStopWatchSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Stop Watch Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = StopWatchSettings::class;
