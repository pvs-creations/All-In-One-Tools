...
class ManageTemperatureConverterSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Temperature Converter Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = TemperatureConverterSettings::class;
