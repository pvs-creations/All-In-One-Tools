...
class ManageTextRepeaterSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Text Repeater Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = TextRepeaterSettings::class;
