...
class ManageTextReplacerSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Text Replacer Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = TextReplacerSettings::class;
