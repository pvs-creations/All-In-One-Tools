...
class ManageTextReverserSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Text Reverser Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = TextReverserSettings::class;
