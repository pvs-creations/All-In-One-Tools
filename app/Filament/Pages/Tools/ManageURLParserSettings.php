...
class ManageURLParserSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Url Parser Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = URLParserSettings::class;
