...
class ManageUnicodeToPunycodeSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Unicode To Punycode Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = UnicodeToPunycodeSettings::class;
