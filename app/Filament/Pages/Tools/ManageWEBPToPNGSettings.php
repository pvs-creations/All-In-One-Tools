...
class ManageWEBPToPNGSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Webp To Png Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = WEBPToPNGSettings::class;
