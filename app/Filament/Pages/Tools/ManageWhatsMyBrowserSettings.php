...
class ManageWhatsMyBrowserSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Whats My Browser Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = WhatsMyBrowserSettings::class;
