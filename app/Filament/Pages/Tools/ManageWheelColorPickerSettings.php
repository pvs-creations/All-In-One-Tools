...
class ManageWheelColorPickerSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Wheel Color Picker Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = WheelColorPickerSettings::class;
