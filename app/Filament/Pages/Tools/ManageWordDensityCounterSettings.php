...
class ManageWordDensityCounterSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Word Density Counter Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = WordDensityCounterSettings::class;
