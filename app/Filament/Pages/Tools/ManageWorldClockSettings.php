...
class ManageWorldClockSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'World Clock Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = WorldClockSettings::class;
