...
class ManageXmlToJsonSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Xml To Json Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = XmlToJsonSettings::class;
