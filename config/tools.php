<?php
use App\Http\Controllers\Tools\WhatsMyBrowserController;
use App\Http\Controllers\Tools\JsonToXmlController;
use App\Http\Controllers\Tools\XmlToJsonController;
use App\Http\Controllers\Tools\OpenPortCheckerController;
use App\Http\Controllers\Tools\PasteAndShareTextController;
use App\Http\Controllers\Tools\JsonBeautifierController;
use App\Http\Controllers\Tools\JsonValidatorController;
use App\Http\Controllers\Tools\BmiCalculatorController;
use App\Http\Controllers\Tools\SmtpTestController;
use App\Http\Controllers\Tools\GzipTestController;
use App\Http\Controllers\Tools\QuotedPrintableEncodeController;
use App\Http\Controllers\Tools\QuotedPrintableDecodeController;
use App\Http\Controllers\Tools\WorldClockController;
...
use App\Filament\Pages\Tools\ManageCSSFormatterSettings;
...
use App\Filament\Pages\Tools\ManageBase64ToTextSettings;
use App\Filament\Pages\Tools\ManageDnsLookupSettings;
...
use App\Filament\Pages\Tools\ManageWhatsMyIpSettings;
...
use App\Filament\Pages\Tools\ManageWhatsMyBrowserSettings;
use App\Filament\Pages\Tools\ManageJsonToXmlSettings;
use App\Filament\Pages\Tools\ManageXmlToJsonSettings;
use App\Filament\Pages\Tools\ManageOpenPortCheckerSettings;
use App\Filament\Pages\Tools\ManageJsonBeautifierSettings;
use App\Filament\Pages\Tools\ManageJsonValidatorSettings;
use App\Filament\Pages\Tools\ManageBmiCalculatorSettings;
use App\Filament\Pages\Tools\ManageSmtpTestSettings;
use App\Filament\Pages\Tools\ManageGzipTestSettings;
use App\Filament\Pages\Tools\ManageRandomTextLineSettings;
use App\Filament\Pages\Tools\ManageQuotedPrintableEncodeSettings;
use App\Filament\Pages\Tools\ManageQuotedPrintableDecodeSettings;
...
use App\Settings\Tools\Base64ToTextSettings;
use App\Settings\Tools\DnsLookupSettings;
...
use App\Settings\Tools\WhatsMyBrowserSettings;
use App\Settings\Tools\JsonToXmlSettings;
use App\Settings\Tools\XmlToJsonSettings;
use App\Settings\Tools\OpenPortCheckerSettings;
use App\Settings\Tools\JsonBeautifierSettings;
use App\Settings\Tools\JsonValidatorSettings;
use App\Settings\Tools\BmiCalculatorSettings;
use App\Settings\Tools\SmtpTestSettings;
use App\Settings\Tools\GzipTestSettings;
use App\Settings\Tools\RandomTextLineSettings;
use App\Settings\Tools\QuotedPrintableEncodeSettings;
use App\Settings\Tools\QuotedPrintableDecodeSettings;
use App\Settings\Tools\LengthConverterSettings;
use App\Filament\Pages\Tools\ManageLengthConverterSettings;
use App\Settings\Tools\SpeedConverterSettings;
use App\Filament\Pages\Tools\ManageSpeedConverterSettings;
use App\Settings\Tools\TemperatureConverterSettings;
use App\Filament\Pages\Tools\ManageTemperatureConverterSettings;
use App\Settings\Tools\WeightConverterSettings;
use App\Filament\Pages\Tools\ManageWeightConverterSettings;
use App\Settings\Tools\CountDownTimerSettings;
use App\Filament\Pages\Tools\ManageCountDownTimerSettings;
use App\Settings\Tools\StopWatchSettings;
use App\Filament\Pages\Tools\ManageStopWatchSettings;
use App\Settings\Tools\ScientificCalculatorSettings;
use App\Filament\Pages\Tools\ManageScientificCalculatorSettings;
use App\Settings\Tools\WorldClockSettings;
use App\Filament\Pages\Tools\ManageWorldClockSettings;
use App\Settings\Tools\WheelColorPickerSettings;
use App\Filament\Pages\Tools\ManageWheelColorPickerSettings;
use App\Settings\Tools\VirtualCoinFlipSettings;
use App\Filament\Pages\Tools\ManageVirtualCoinFlipSettings;
use App\Settings\Tools\TextRepeaterSettings;
use App\Filament\Pages\Tools\ManageTextRepeaterSettings;
use App\Settings\Tools\AimTrainerSettings;
use App\Filament\Pages\Tools\ManageAimTrainerSettings;
use App\Settings\Tools\ImageRotateSettings;
use App\Filament\Pages\Tools\ManageImageRotateSettings;
use App\Settings\Tools\ImageToGrayscaleSettings;
use App\Filament\Pages\Tools\ManageImageToGrayscaleSettings;
use App\Settings\Tools\DatePickerCalendarSettings;
use App\Filament\Pages\Tools\ManageDatePickerCalendarSettings;
use App\Settings\Tools\PasteAndShareTextSettings;
use App\Filament\Pages\Tools\ManagePasteAndShareTextSettings;
use App\Settings\Tools\HtmlCodeEditorSettings;
use App\Filament\Pages\Tools\ManageHtmlCodeEditorSettings;
            ...
            'tools' => [
                ...
                'WhatsMyIp' => [
                    ...
                    'admin' => [
                        ...
                        'settings-page' => ManageWhatsMyIpSettings::class
                    ]
                ],
        ...
        'Converters' => [
            ...
            'tools' => [
                ...
                'Base64ToText' => [
                    ...
                    'settings'  => Base64ToTextSettings::class,
                    'view' => 'modules.tools.base64-to-text.view',

                    'templates' => [
                        'header'   => 'modules.tools.base64-to-text.header',
                        'selector' => 'modules.tools.base64-to-text.selector'
                    ],

                    'admin' => [
                        'title'         => 'Base64 To Text',
                        'summary'       => 'Convert Base64 To Text',
                        'settings-page' => ManageBase64ToTextSettings::class
                    ]
                ],
                ...
                'JsonToXml' => [
                    ...
                    'settings'  => JsonToXmlSettings::class,
                    'controller' => JsonToXmlController::class,

                    'templates' => [
                        'header'   => 'modules.tools.json-to-xml.header',
                        'selector' => 'modules.tools.json-to-xml.selector'
                    ],

                    'admin' => [
                        'title'         => 'JSON To XML',
                        'summary'       => 'It helps to convert your JSON data to XML format.',
                        'settings-page' => ManageJsonToXmlSettings::class
                    ]
                ],
                ...
                'XmlToJson' => [
                    ...
                    'settings'  => XmlToJsonSettings::class,
                    'controller' => XmlToJsonController::class,

                    'templates' => [
                        'header'   => 'modules.tools.xml-to-json.header',
                        'selector' => 'modules.tools.xml-to-json.selector'
                    ],

                    'admin' => [
                        'title'         => 'XML To JSON',
                        'summary'       => 'It helps to convert your XML data to JSON format.',
                        'settings-page' => ManageXmlToJsonSettings::class
                    ]
                ],
                ...
                'JsonBeautifier' => [
                    ...
                    'settings'  => JsonBeautifierSettings::class,
                    'controller' => JsonBeautifierController::class,

                    'templates' => [
                        'header'   => 'modules.tools.json-beautifier.header',
                        'selector' => 'modules.tools.json-beautifier.selector'
                    ],

                    'admin' => [
                        'title'         => 'JSON Beautifier',
                        'summary'       => 'Online JSON Viewer, JSON Beautifier and Formatter to beautify and tree view of JSON data.',
                        'settings-page' => ManageJsonBeautifierSettings::class
                    ]
                ],
                ...
                'JsonValidator' => [
                    ...
                    'settings'  => JsonValidatorSettings::class,
                    'controller' => JsonValidatorController::class,

                    'templates' => [
                        'header'   => 'modules.tools.json-validator.header',
                        'selector' => 'modules.tools.json-validator.selector'
                    ],

                    'admin' => [
                        'title'         => 'JSON Validator',
                        'summary'       => 'JSON Validator is the free online validator tool for JSON.',
                        'settings-page' => ManageJsonValidatorSettings::class
                    ]
                ],
                ...
                'LengthConverter' => [
                    ...
                    'settings' => LengthConverterSettings::class,

                    'view' => 'modules.tools.length-converter.view',
                    'templates' => [
                        'header' => 'modules.tools.length-converter.header',
                        'selector' => 'modules.tools.length-converter.selector',
                    ],

                    'admin' => [
                        'title' => 'Length Converter',
                        'summary' => 'Convert Distance Units',
                        'settings-page' => ManageLengthConverterSettings::class
                    ]
                ],
                ...
                'HtmlCodeEditor' => [
                    ...
                    'settings' => HtmlCodeEditorSettings::class,
                    ...
                    'view' => 'modules.tools.html-code-editor.view',
                    'templates' => [
                        'header' => 'modules.tools.html-code-editor.header',
                        'selector' => 'modules.tools.html-code-editor.selector',
                    ],

                    'admin' => [
                        'title' => 'HTML Code Editor',
                        'summary' => 'Free online HTML code editor with instant live preview. Enter your code in the editor and see the preview changing as you type. Compose your documents easily without installing any program.',
                        'settings-page' => ManageHtmlCodeEditorSettings::class
                    ]
                ],
                ...
                'SpeedConverter' => [
                    ...
                    'settings' => SpeedConverterSettings::class,

                    'view' => 'modules.tools.speed-converter.view',
                    'templates' => [
                        'header' => 'modules.tools.speed-converter.header',
                        'selector' => 'modules.tools.speed-converter.selector',
                    ],

                    'admin' => [
                        'title' => 'Speed Converter',
                        'summary' => 'Convert Speed Units',
                        'settings-page' => ManageSpeedConverterSettings::class
                    ]
                ],
                ...
                'TemperatureConverter' => [
                    ...
                    'settings' => TemperatureConverterSettings::class,

                    'view' => 'modules.tools.temperature-converter.view',
                    'templates' => [
                        'header' => 'modules.tools.temperature-converter.header',
                        'selector' => 'modules.tools.temperature-converter.selector',
                    ],

                    'admin' => [
                        'title' => 'Temperature Converter',
                        'summary' => 'Convert Temperature Units',
                        'settings-page' => ManageTemperatureConverterSettings::class
                    ]
                ],
                ...
                'WeightConverter' => [
                    ...
                    'settings' => WeightConverterSettings::class,

                    'view' => 'modules.tools.weight-converter.view',
                    'templates' => [
                        'header' => 'modules.tools.weight-converter.header',
                        'selector' => 'modules.tools.weight-converter.selector',
                    ],

                    'admin' => [
                        'title' => 'Weight Converter',
                        'summary' => 'Convert Weight Units',
                        'settings-page' => ManageWeightConverterSettings::class
                    ]
                ],
            ]
        ],
            ...
            'tools' => [
                ...
                'JSMinifier' => [
                    ...
                    'scripts' => [
                        ...
                        [ 'js/uglify/minify.js', 'internal' ],
                        [ 'js/uglify/utils.js', 'internal' ],
                        [ 'js/uglify/ast.js', 'internal' ],
                        [ 'js/uglify/parse.js', 'internal' ],
                        [ 'js/uglify/transform.js', 'internal' ],
                        [ 'js/uglify/scope.js', 'internal' ],
                        [ 'js/uglify/output.js', 'internal' ],
                        [ 'js/uglify/compress.js', 'internal' ],
                        [ 'js/uglify/propmangle.js', 'internal' ],
                ...
                'CSSFormatter' => [
                    ...
                    'admin' => [
                        ...
                        'settings-page' => ManageCSSFormatterSettings::class
                    ]
                ],
                ...
                'RandomTextLine' => [
                    'name' => 'random-text-line',

                    'settings'  => RandomTextLineSettings::class,
                    'view'      => 'modules.tools.random-text-line.view',

                    'templates' => [
                        'header'   => 'modules.tools.random-text-line.header',
                        'selector' => 'modules.tools.random-text-line.selector'
                    ],

                    'admin' => [
                        'title'         => 'Randomize / Shuffle Text Lines',
                        'summary'       => 'This online tool randomizes / shuffle text lines provided as input. Get the random lines.',
                        'settings-page' => ManageRandomTextLineSettings::class
                    ]
                ],
                ...
                'QuotedPrintableEncode' => [
                    ...
                    'settings'  => QuotedPrintableEncodeSettings::class,
                    'controller' => QuotedPrintableEncodeController::class,

                    'templates' => [
                        'header'   => 'modules.tools.quoted-printable-encode.header',
                        'selector' => 'modules.tools.quoted-printable-encode.selector'
                    ],

                    'admin' => [
                        'title'         => 'Encode Quoted Printable',
                        'summary'       => 'To encode a regular text to Quoted Printable, type in the box on top and click the Encode button.',
                        'settings-page' => ManageQuotedPrintableEncodeSettings::class
                    ]
                ],
                ...
                'QuotedPrintableDecode' => [
                    ...
                    'settings'  => QuotedPrintableDecodeSettings::class,
                    'controller' => QuotedPrintableDecodeController::class,

                    'templates' => [
                        'header'   => 'modules.tools.quoted-printable-decode.header',
                        'selector' => 'modules.tools.quoted-printable-decode.selector'
                    ],

                    'admin' => [
                        'title'         => 'Decode Quoted Printable',
                        'summary'       => 'To decode a regular text to Quoted Printable, type in the box on top and click the Decode button.',
                        'settings-page' => ManageQuotedPrintableDecodeSettings::class
                    ]
                ],
                ...
                'CountDownTimer' => [
                    ...
                    'settings' => CountDownTimerSettings::class,

                    'view' => 'modules.tools.count-down-timer.view',
                    'templates' => [
                        'header' => 'modules.tools.count-down-timer.header',
                        'selector' => 'modules.tools.count-down-timer.selector',
                    ],

                    'admin' => [
                        'title' => 'Count Down Timer',
                        'summary' => 'Countdown Timer that counts down in seconds, minutes and hours',
                        'settings-page' => ManageCountDownTimerSettings::class
                    ]
                ],
                ...
                'StopWatch' => [
                    ...
                    'settings' => StopWatchSettings::class,

                    'view' => 'modules.tools.stop-watch.view',
                    'templates' => [
                        'header' => 'modules.tools.stop-watch.header',
                        'selector' => 'modules.tools.stop-watch.selector',
                    ],

                    'admin' => [
                        'title' => 'Stop Watch',
                        'summary' => 'Fast Stopwatch and Online Countdown timer always available when you need it',
                        'settings-page' => ManageStopWatchSettings::class
                    ]
                ],
                ...
                'ScientificCalculator' => [
                    ...
                    'settings' => ScientificCalculatorSettings::class,

                    'view' => 'modules.tools.scientific-calculator.view',
                    'templates' => [
                        'header' => 'modules.tools.scientific-calculator.header',
                        'selector' => 'modules.tools.scientific-calculator.selector',
                    ],

                    'admin' => [
                        'title' => 'Scientific Calculator',
                        'summary' => 'Scientific Calculator with double-digit precision that supports both button click and keyboard type',
                        'settings-page' => ManageScientificCalculatorSettings::class
                    ]
                ],
                ...
                'WorldClock' => [
                    ...
                    'settings' => WorldClockSettings::class,
                    'controller' => WorldClockController::class,

                    'view' => 'modules.tools.world-clock.view',

                    'templates' => [
                        'header' => 'modules.tools.world-clock.header',
                        'selector' => 'modules.tools.world-clock.selector',
                    ],

                    'admin' => [
                        'title' => 'World Clock',
                        'summary' => 'The time zone abbreviations and acronyms worldwide',
                        'settings-page' => ManageWorldClockSettings::class
                    ]
                ...
                'WheelColorPicker' => [
                    ...
                    'settings' => WheelColorPickerSettings::class,

                    'view' => 'modules.tools.wheel-color-picker.view',
                    'templates' => [
                        'header' => 'modules.tools.wheel-color-picker.header',
                        'selector' => 'modules.tools.wheel-color-picker.selector',
                    ],

                    'admin' => [
                        'title' => 'Wheel Color Picker',
                        'summary' => 'Dive into the world of gooey fun! Spin the wheel to craft your unique slime masterpiece',
                        'settings-page' => ManageWheelColorPickerSettings::class
                    ]
                ],
                ...
                'VirtualCoinFlip' => [
                    ...
                    'settings' => VirtualCoinFlipSettings::class,

                    'view' => 'modules.tools.virtual-coin-flip.view',
                    'templates' => [
                        'header' => 'modules.tools.virtual-coin-flip.header',
                        'selector' => 'modules.tools.virtual-coin-flip.selector',
                    ],

                    'admin' => [
                        'title' => ' Virtual Coin Flip',
                        'summary' => 'Coin Flip is an online heads or tails coin toss simulator',
                        'settings-page' => ManageVirtualCoinFlipSettings::class
                    ]
                ],
                ...
                'TextRepeater' => [
                    ...
                    'settings' => TextRepeaterSettings::class,

                    'view' => 'modules.tools.text-repeater.view',
                    'templates' => [
                        'header' => 'modules.tools.text-repeater.header',
                        'selector' => 'modules.tools.text-repeater.selector',
                    ],

                    'admin' => [
                        'title' => ' Text Repeater',
                        'summary' => 'Text repeater is an online tool to generate a single word or string multiple times',
                        'settings-page' => ManageTextRepeaterSettings::class
                    ]
                ],
                ...
                'AimTrainer' => [
                    ...
                    'settings' => AimTrainerSettings::class,

                    'view' => 'modules.tools.aim-trainer.view',
                    'templates' => [
                        'header' => 'modules.tools.aim-trainer.header',
                        'selector' => 'modules.tools.aim-trainer.selector',
                    ],

                    'admin' => [
                        'title' => ' Aim Trainer',
                        'summary' => 'Aim Trainer is a free browser game that is specifically designed to improve the players aim',
                        'settings-page' => ManageAimTrainerSettings::class
                    ]
                ],
                ...
                'ImageRotate' => [
                    ...
                    'settings' => ImageRotateSettings::class,

                    'view' => 'modules.tools.image-rotate.view',
                    'templates' => [
                        'header' => 'modules.tools.image-rotate.header',
                        'selector' => 'modules.tools.image-rotate.selector',
                    ],

                    'admin' => [
                        'title' => ' Image Rotate',
                        'summary' => 'Rotate only images with portrait or landscape orientation at once',
                        'settings-page' => ManageImageRotateSettings::class
                    ]
                ],
                ...
                'ImageToGrayscale' => [
                    ...
                    'settings' => ImageToGrayscaleSettings::class,

                    'view' => 'modules.tools.image-to-grayscale.view',
                    'templates' => [
                        'header' => 'modules.tools.image-to-grayscale.header',
                        'selector' => 'modules.tools.image-to-grayscale.selector',
                    ],

                    'admin' => [
                        'title' => 'Image to Grayscale',
                        'summary' => 'Grayscale image is an online free tool to convert images into Grayscale',
                        'settings-page' => ManageImageToGrayscaleSettings::class
                    ]
                ],
                ...
                'DatePickerCalendar' => [
                    ...
                    'settings' => DatePickerCalendarSettings::class,

                    'view' => 'modules.tools.date-picker-calendar.view',
                    'templates' => [
                        'header' => 'modules.tools.date-picker-calendar.header',
                        'selector' => 'modules.tools.date-picker-calendar.selector',
                    ],

                    'admin' => [
                        'title' => 'Date Picker Calendar',
                        'summary' => 'Date Picker Calendar allow the selection of a specific date and year',
                        'settings-page' => ManageDatePickerCalendarSettings::class
                    ]
                ],

                'PasteAndShareText' => [
                    'name' => 'paste-and-share-text',

                    'settings' => PasteAndShareTextSettings::class,
                    'controller' => PasteAndShareTextController::class,

                    'view' => 'modules.tools.paste-and-share-text.view',
                    'templates' => [
                        'header' => 'modules.tools.paste-and-share-text.header',
                        'selector' => 'modules.tools.paste-and-share-text.selector',
                    ],

                    'admin' => [
                        'title' => 'Paste & Share Text',
                        'summary' => 'Online Text Sharing easy way to share text online',
                        'settings-page' => ManagePasteAndShareTextSettings::class
                    ]
                ],
            ]
        ],
        ...
        'Domains' => [
            ...
            'tools' => [
                ...
                'DnsLookup' => [
                    ...
                    'settings'  => DnsLookupSettings::class,
                    'view' => 'modules.tools.dns-lookup.view',

                    'templates' => [
                        'header'   => 'modules.tools.dns-lookup.header',
                        'selector' => 'modules.tools.dns-lookup.selector'
                    ],

                    'admin' => [
                        'title'         => 'Dns Lookup',
                        'summary'       => 'Online dnslookup is a web based DNS client that queries DNS records for a given domain name.',
                        'settings-page' => ManageDnsLookupSettings::class
                    ]
                ],
                ...
                'WhatsMyBrowser' => [
                    ...
                    'settings'  => WhatsMyBrowserSettings::class,
                    'controller' => WhatsMyBrowserController::class,

                    'templates' => [
                        'header'   => 'modules.tools.whats-my-browser.header',
                        'selector' => 'modules.tools.whats-my-browser.selector'
                    ],

                    'admin' => [
                        'title'         => 'What is My Browser',
                        'summary'       => 'What browser do I have? Find out my browser.',
                        'settings-page' => ManageWhatsMyBrowserSettings::class
                    ]
                ],
                ...
                'OpenPortChecker' => [
                    ...
                    'settings'  => OpenPortCheckerSettings::class,
                    'controller' => OpenPortCheckerController::class,

                    'templates' => [
                        'header'   => 'modules.tools.open-port-checker.header',
                        'selector' => 'modules.tools.open-port-checker.selector'
                    ],

                    'admin' => [
                        'title'         => 'Open Port Checker',
                        'summary'       => 'The open port checker is a tool you can use to check your external IP address and detect open ports on your connection.',
                        'settings-page' => ManageOpenPortCheckerSettings::class
                    ]
                ],
                ...
                'BmiCalculator' => [
                    ...
                    'settings'  => BmiCalculatorSettings::class,
                    'controller' => BmiCalculatorController::class,

                    'templates' => [
                        'header'   => 'modules.tools.bmi-calculator.header',
                        'selector' => 'modules.tools.bmi-calculator.selector'
                    ],

                    'admin' => [
                        'title'         => 'BMI Calculator',
                        'summary'       => 'Body mass index (BMI) is a measure of body fat based on height and weight that applies to adult men and women.',
                        'settings-page' => ManageBmiCalculatorSettings::class
                    ]
                ],
                ...
                'SmtpTest' => [
                    ...
                    'settings'  => SmtpTestSettings::class,
                    'controller' => SmtpTestController::class,

                    'templates' => [
                        'header'   => 'modules.tools.smtp-test.header',
                        'selector' => 'modules.tools.smtp-test.selector'
                    ],

                    'admin' => [
                        'title'         => 'Online SMTP Test',
                        'summary'       => 'Free advanced online tool to Test and check your SMTP server.',
                        'settings-page' => ManageSmtpTestSettings::class
                    ]
                ],
                ...
                'GzipTest' => [
                    ...
                    'settings'  => GzipTestSettings::class,
                    'controller' => GzipTestController::class,

                    'templates' => [
                        'header'   => 'modules.tools.gzip-test.header',
                        'selector' => 'modules.tools.gzip-test.selector'
                    ],

                    'admin' => [
                        'title'         => 'GZIP Compression Test',
                        'summary'       => 'Test if Gzip is working on your website.',
                        'settings-page' => ManageGzipTestSettings::class
                    ]
                ],
            ]
        ],
