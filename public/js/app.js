  ...
  return {
    ...
    init: function init() {
      ...
      this.tools.forEach(function (tool) {
        return tool.setAttribute('data-query', tool.dataset.name.toLowerCase().trim().replace(/\s/g, '') + tool.dataset.summary.toLowerCase().trim().replace(/\s/g, ''));
      });
      this.$el.addEventListener('input', function () {
        var query = _this.$el.value.trim().toLowerCase().replace(/\s/g, '');
        _this.tools.forEach(function (tool) {
          return !tool.dataset.query.includes(query) ? tool.classList.add('d-none') : tool.classList.remove('d-none');
        });
...
window.bitflanToolBaseSearchComponent = function () {
  return {
    ...
    update: function update() {
      ...
      var results = 0;
      if (this.query) {
        var search = this.query.toLowerCase().replace(/\s+/g, '');
...
/******/ 	__webpack_require__.O(undefined, ["css/theme","css/app"], () => (__webpack_require__("./resources/scss/style.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/theme","css/app"], () => (__webpack_require__("./resources/css/backend.css")))
