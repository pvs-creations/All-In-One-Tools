...
<div class="single-page-sec">
    ...
    <div class="single-page-inner">
        <form method="POST" action="{{ route('register-store') }}">
            ...
            @if($recaptcha)
                <div class="col-12">
                    <div class="g-recaptcha" data-sitekey="{{ $generalSettings->recaptchaSiteKey }}"></div>
                </div>
            @endif
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('login') }}" class="btn custom--btn button__lg copy-btn btn__dark mt-2 ">
