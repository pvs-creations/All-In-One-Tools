            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="custom-label">{{ trans('webtools/tools/temperature-converter.labelFahrenheit') }}</label>
                        <input id="inputFahrenheit" class="custom-input" type="number" min="-459.66999999999996" placeholder="{{ trans('webtools/tools/temperature-converter.labelFahrenheit') }}" oninput="temperatureConverter(this.id,this.value)" onchange="temperatureConverter(this.id,this.value)">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="custom-label">{{ trans('webtools/tools/temperature-converter.labelCelsius') }}</label>
                        <input id="inputCelsius" class="custom-input" type="number" min="-273.15" placeholder="{{ trans('webtools/tools/temperature-converter.labelCelsius') }}" oninput="temperatureConverter(this.id,this.value)" onchange="temperatureConverter(this.id,this.value)">
                    </div>
                </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                        <label class="custom-label">{{ trans('webtools/tools/temperature-converter.labelKelvin') }}</label>
                        <input id="inputKelvin" class="custom-input" type="number" min="0" placeholder="{{ trans('webtools/tools/temperature-converter.labelKelvin') }}" oninput="temperatureConverter(this.id,this.value)" onchange="temperatureConverter(this.id,this.value)">
                    </div>
                </div>
            </div>
        </form>
