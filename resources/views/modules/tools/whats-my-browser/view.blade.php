    ...
    <div class="single-page-inner">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>{{ trans('webtools/tools/whats-my-browser.your_browser') }}</th>
                        <th>{{ trans('webtools/tools/whats-my-browser.browser_version') }}</th>
                        <th>{{ trans('webtools/tools/whats-my-browser.operating_system') }}</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>{{ $ua['name'] }}</td>
                        <td><span class="badge bg-success">{{ $ua['version'] }}</span></td>
                        <td>{{ $ua['platform'] }}</td>
                    </tr>
                </tbody>
            </table>
