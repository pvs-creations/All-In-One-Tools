    ...
    <div class="single-page-inner">
        <div class="table-responsive">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>{{ trans('webtools/tools/world-clock.text_Country_Code') }}</th>
                        <th>{{ trans('webtools/tools/world-clock.text_Name') }}</th>
                        <th>{{ trans('webtools/tools/world-clock.text_date_time') }}</th>
                        <th>{{ trans('webtools/tools/world-clock.text_UTC_Offset') }}</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($times as $dtime)
                        <tr>
                            <td>{{ $dtime['location'] }}</td>
                            <td>{{ $dtime['name'] }}</td>
                            <td>{{ $dtime['time'] }}</td>
                            <td>{{ trans('webtools/tools/world-clock.text_UTC') }}{{ $dtime['offset'] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
